...
Revision ID: 36435ee8fecd
Revises: 38e0e8e8324d
Create Date: 2023-05-30 01:21:11.681410
...
revision = '36435ee8fecd'
down_revision = '38e0e8e8324d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('dev_environment_test_logs', schema=None) as batch_op:
        batch_op.add_column(sa.Column('is_information_retrieved_valid', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('is_query_within_domain', sa.Boolean(), nullable=True))
        batch_op.alter_column('is_lang_correct',
